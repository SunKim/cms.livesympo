...
class ProjectModel extends Model {
    ...
    public function list ($admSeq, $lvl, $filter, $beginIndex, $endIndex) {
		...
		$strQry .= "	, P.STREAM_URL, P.ONAIR_YN, P.ONAIR_ENT_TRM, P.MAIN_IMG_URI, P.MAIN_IMG_THUMB_URI, P.AGENDA_IMG_URI, P.AGENDA_IMG_THUMB_URI, P.FOOTER_IMG_URI, P.FOOTER_IMG_THUMB_URI	\n";
    ...
    public function detail ($prjSeq) {
		...
		$strQry .= "	, P.STREAM_BODY_COLR, P.STREAM_BTN_BG_COLR, P.STREAM_BTN_FONT_COLR, P.STREAM_QA_BG_COLR, P.STREAM_QA_FONT_COLR, P.MDRTOR_FONT_COLR	\n";
