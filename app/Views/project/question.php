						...
						<div class="card-body d-flex justify-content-between align-items-start">
							...
							<div class="question-container">
								<div class="d-flex justify-content-between align-items-center">
									...
									<button class="btn-sub btn-blue" onclick="getQuestionList(<?= $project['PRJ_SEQ'] ?>);">수동
										새로고침</button>
								</div>
								<hr />
								<div>
			...
			success: function(data) {
				...
				if (data.resCode == '0000') {
					...
					list.forEach(item => {
						...
						html +=
							`			<button class="btn-sub btn-gray ml5" onclick="deleteQuestion(${item.QST_SEQ});">삭제</button>`;
						html += `		</p>`;
						html += `		<div>`;
