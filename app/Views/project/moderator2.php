...
<head>
	...
	div.container-fluid {
		...
		background-image: url(<?= $project['MDRTOR_IMG_URL'] ?>);
	...
	.swiper-pagination-fraction {
		color: <?=$project['MDRTOR_PAGE_FONT_COLR'] ?>;
		font-size: <?=$project['MDRTOR_PAGE_FONT_SIZE'] ?>px;
		font-weight: bold;
	}

	.swiper-button-prev,
	.swiper-button-next {
		--swiper-navigation-color: <?=$project['MDRTOR_ARROW_COLR'] ?>;
	}

	/* 기본 화살표 완전히 숨기기 - 모든 가상 요소 제거 */
	...
	.swiper-button-prev::before {
		...
		color: <?=$project['MDRTOR_ARROW_COLR'] ?> !important;
