...
class ProjectModel extends Model {
    ...
    public function list ($admSeq, $lvl, $filter, $beginIndex, $endIndex) {
		...
		$strQry .= "	, P.STREAM_URL, P.ONAIR_YN, P.ONAIR_ENT_TRM, P.MAIN_IMG_URI, P.MAIN_IMG_THUMB_URI, P.AGENDA_IMG_URI, P.AGENDA_IMG_THUMB_URI, P.STREAM_AGENDA_IMG_URI, P.STREAM_AGENDA_IMG_THUMB_URI, P.FOOTER_IMG_URI, P.FOOTER_IMG_THUMB_URI	\n";
    ...
    public function detail ($prjSeq) {
        ...
        $strQry .= "	, CONN_ROUTE_TEXT, CONN_ROUTE_1, CONN_ROUTE_2, CONN_ROUTE_3, CONN_ROUTE_4, CONN_ROUTE_5, CONN_ROUTE_6	\n";
        ...
        $strQry .= "	, P.MDRTOR_FONT_COLR, P.MDRTOR_ARROW_COLR, P.MDRTOR_PAGE_FONT_SIZE, P.MDRTOR_PAGE_FONT_COLR	\n";
		$strQry .= "	, CONCAT('".$_ENV['app.baseURL']."', P.MDRTOR_IMG_URI) AS MDRTOR_IMG_URL	\n";
